...
<?php if (isset($_SESSION['todo_list/new-task'])): ?>
    <div class="alert-dark mt-3">
        Sukurta nauja užduotis: <?= ucfirst($_SESSION['todo_list/new-task'][0]); ?>
    </div>
<?php endif; ?>
            ...
            <?php foreach ($tasks->allTasks() as $task): ?>
                <?php if ($task['status'] == 1): ?>
                    <tr class="line">
                        ...
                        <td><a href="delete-task/id/<?= $task['id']; ?>" class="btn btn-dark" name="delete">Delete</a>
                        </td>
                    </tr>
                <?php else: ?>
                    <tr>
